					...
					<div className="flex flex-col sm:flex-row items-center gap-6 sm:gap-[90px] flex-[0_0_auto] sm:mr-[-151.00px]">
						<div className="flex flex-col items-start sm:gap-12 pr-6 sm:pr-0 gap-4 relative flex-[0_0_auto]">
							<div className="flex flex-col sm:w-[538px] w-full items-start gap-6 relative flex-[0_0_auto]">
								<p className="font-semibold text-[28px] sm:text-5xl leading-[36px] sm:leading-[62px] text-center sm:text-left px-2 sm:px-0 bg-[linear-gradient(92.77deg,#080C1D_7.73%,#7E808C_99.72%)] dark:bg-[linear-gradient(92.99deg,#FFFFFF_14.12%,#AAAAAA_96.26%)] bg-clip-text text-transparent">
									Learn more about us and the team behind this disruptive innovation.
								</p>
							</div>

							<div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-6 relative flex-[0_0_auto] w-full">
								<button className="flex h-[46px] sm:h-[56px] items-center justify-center gap-4 pl-[18px] pr-0.5 sm:pl-6 sm:pr-1 py-4 bg-primary rounded-[54px] ring-2 ring-textSecondary/15 dark:ring-white/10 z-10">
								...
								<button className=" inline-flex h-[46px] sm:h-[56px] items-center justify-center gap-4 pl-[18px] pr-0.5 sm:pl-6 sm:pr-1 py-4 dark:bg-bgc bg-textDark  rounded-[54px] ring-2 ring-textSecondary/5 dark:ring-white/10 z-7  ">
									<div className="font-semibold text-sm sm:text-base leading-6 whitespace-nowrap text-text  ">
